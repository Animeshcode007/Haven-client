...
const Navbar = ({ onOpenCreatePostModal }) => {
  ...
  console.log("3. Navbar: Received onOpenCreatePostModal prop. Is it a function?", typeof onOpenCreatePostModal);
  const showCreatePostIcon = location.pathname === "/dashboard";
  console.log("4. Navbar: Current path is", location.pathname, "Should show icon?", showCreatePostIcon);
